...
| [Desktop Assistant Handoff](../DESKTOP_ASSISTANT_HANDOFF.md) | Working orders for the desktop Claude: guardrails, sprint queue in pseudocode (B/C/D/F), paperwork duties, real-hardware button audit, mirror-skills install (§6) |
| [Handoff Memo 2026-07-13](../HANDOFF_MEMO_2026-07-13.md) | State-of-the-world accounting: what merged in PR #50 + the six desktop-only open items |
